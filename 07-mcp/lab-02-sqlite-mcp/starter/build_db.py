#!/usr/bin/env python3
"""Build library.db from scratch. Re-run any time to reset.

The database has three tables:

    authors(id, name)
    books(id, title, author_id, year)
    checkouts(id, book_id, borrower, checked_out_on, returned_on)

Totally fake data. The point is just to have something with joins and
aggregates so queries in this lab are non-trivial.
"""
